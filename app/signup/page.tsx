      ...
      <div className="w-full max-w-md">
        ...
        <Card className="shadow-lg">
          <CardHeader className="text-center">
            ...
            <CardDescription>Create your account and discover amazing opportunities</CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              <Button variant="outline" onClick={() => handleSocialSignup("phone")} className="flex items-center gap-2">
